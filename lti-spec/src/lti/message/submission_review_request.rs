...
use crate::lti::claims::for_user::ForUser;
...
pub struct SubmissionReviewRequest {
    ...
    pub for_user: ForUser,

    #[serde(flatten)]
    pub options: SubmissionReviewRequestOptions,
...
pub struct SubmissionReviewRequestOptions {
